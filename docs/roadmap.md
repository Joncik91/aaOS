...
Phase F-b is in progress, split into three sub-projects. Sub-project 1 (Gaps 1 + 4 — reasoning-slot scheduler + per-task TTL/latency) shipped 2026-04-18 across commits `c2b56de` through `9b8e15a`. Sub-project 2 (Gap 2 — dynamic model routing) shipped 2026-04-19 across commits `cd55c8c` through `68c9112`. Sub-project 3 (Gap 3 — runtime-side tool confinement) is next.
