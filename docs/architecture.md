...
Built-in tools: `echo`, `web_fetch`, `file_read`, `file_read_many`, `file_list`, `file_write`, `file_edit`, `grep`, `spawn_agent`, `spawn_agents`, `memory_store`, `memory_query`, `memory_delete`, `skill_read`, `cargo_run`. External tools integrate via the Tool trait.
